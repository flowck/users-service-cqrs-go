...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "email", "status", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"email"}
	userColumnsWithDefault    = []string{"id", "first_name", "last_name", "status", "created_at", "updated_at"}
